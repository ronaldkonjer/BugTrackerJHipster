...
import info.sliceoflife.bugtracker.domain.Label;
import info.sliceoflife.bugtracker.repository.LabelRepository;
...
/**
 * REST controller for managing {@link info.sliceoflife.bugtracker.domain.Label}.
 */
@RestController
@RequestMapping("/api")
